...
--
ALTER TABLE `his_docs`
  MODIFY `doc_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `his_laboratory`
  MODIFY `lab_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `his_prescriptions`
  MODIFY `pres_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `his_vitals`
  MODIFY `vit_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
