...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 15, 2024 at 07:48 AM
...
(1, 'CodeCampBD', 'Administrator', 'admin@gmail.com', 'admin', 'doc-icon.png');
...
(6, 'Doctor', '', '', 'doctor', 'Surgery | Theatre', '12345', '03.webp'),
...
CREATE TABLE `his_laboratory` (
  ...
  `lab_test_price` varchar(500) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `his_laboratory` (`lab_id`, `lab_pat_name`, `lab_pat_ailment`, `lab_pat_number`, `lab_pat_tests`, `lab_pat_results`, `lab_number`, `lab_date_rec`, `lab_test_price`) VALUES
(1, 'Lorem Ipsum ', 'Flu', '7EW0L', '', '', 'K67PL', '2024-04-13 13:30:21', NULL),
(2, 'Mart Developers', 'Fever', '6P8HJ', '', '', '9DMN5', '2024-04-13 13:28:31', NULL),
(3, 'John Doe', 'Malaria', 'RAV6C', 'ECG', 'Your ECG report is good!', '90ZNX', '2024-04-13 13:29:26', NULL),
(4, 'Cynthia Connolly', 'Demo Test', '3Z14K', '', '', 'G0VZU', '2024-04-13 13:30:08', NULL),
(5, 'Christine Moore', 'Demo Test', '4TLG0', '', '', 'RA4UM', '2024-04-13 13:29:50', NULL),
(6, 'Christine Moore', 'Demo Test', '4TLG0', 'Thyroid Test(s)', NULL, 'J56GU', '2024-04-13 07:29:30', NULL),
(8, 'Helen Macdougall', 'Test Test', 'KU8W4', 'Complete Blood Count (CBC) ', NULL, 'RIBQC', '2024-04-13 09:36:06', '400'),
(9, 'Helen Macdougall', 'Test Test', 'KU8W4', 'X-Rays', NULL, 'ZFKTH', '2024-04-13 12:06:29', '500'),
(10, 'asif ul', 'cold', '7A1VK', 'ECG', 'Your ECG report is good!', 'W3MK1', '2024-04-13 13:20:15', '700'),
(11, 'asif ul', 'cold', '7A1VK', 'X-Rays', 'Your X-Rays report is good!', '18YZ3', '2024-04-14 08:26:55', '500'),
(12, 'Michael White', 'Demo Test', 'DCRI8', 'MRI (Magnetic Resonance Imaging)', NULL, 'E9374', '2024-04-13 13:44:05', '4000');
...
CREATE TABLE `his_patients` (
  ...
  `doc_dept` varchar(200) DEFAULT NULL,
  `assign_doc_date` varchar(200) DEFAULT NULL,
  `assign_doc_time` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;


CREATE TABLE `his_receptionists` (
  `re_id` int(11) NOT NULL,
  `re_fname` varchar(200) DEFAULT NULL,
  `re_lname` varchar(200) DEFAULT NULL,
  `re_number` varchar(200) DEFAULT NULL,
  `re_email` varchar(200) DEFAULT NULL,
  `re_pwd` varchar(200) DEFAULT NULL,
  `re_dpic` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
(10, 'Cynthia', 'Connolly add', '10/11/2000', '22', 'S01X5', '9 Hill Haven Drive', '1478885458', 'InPatient', '2024-04-11 05:41:12.134353', 'Demo Test', NULL),
...
(13, 'Md. Mehedi', 'Hasan', '13/01/2001', '21', '85NFV', 'Sonatola Puraton bondor , Sonatola , Bogura .', '01608445456', 'InPatient', '2023-01-24 12:33:05.095935', 'A01', NULL),
(14, 'asif', 'ul', '22/3/2001', '23', '7A1VK', 'naria', '0134533', 'InPatient', '2024-04-13 13:12:18.279549', 'cold', NULL);
...
CREATE TABLE `his_prescriptions` (
  ...
  `pres_pat_ailment` varchar(200) DEFAULT NULL,
   `pres_drug_name` varchar(200) DEFAULT NULL,
  `pres_meal_time` varchar(200) DEFAULT NULL,
  `pres_take_for` varchar(200) DEFAULT NULL,
  `pres_when_eat` varchar(200) DEFAULT NULL,
  `pres_test_name` varchar(200) DEFAULT NULL,
...
--
-- Table structure for table `his_receptionist`
--

CREATE TABLE `his_receptionist` (
  `ad_id` int(11) NOT NULL,
  `ad_fname` varchar(200) DEFAULT NULL,
  `ad_lname` varchar(200) DEFAULT NULL,
  `ad_email` varchar(200) DEFAULT NULL,
...
--
-- Dumping data for table `his_receptionist`
--

INSERT INTO `his_receptionist` (`ad_id`, `ad_fname`, `ad_lname`, `ad_email`, `ad_pwd`, `ad_dpic`) VALUES
(1, 'CodeCampBD', 'receptionist', 'receptionist@gmail.com', 'receptionist', 'doc-icon.png');
...
--
-- Table structure for table `his_tests`
--

CREATE TABLE `his_tests` (
  `test_id` int(11) NOT NULL,
  `test_name` varchar(200) DEFAULT NULL,
  `test_price` varchar(200) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

--
-- Dumping data for table `his_tests`
--

INSERT INTO `his_tests` (`test_id`, `test_name`, `test_price`) VALUES
(1, 'Blood Tests', '800'),
(2, 'Urine Tests', '400'),
(3, 'Complete Blood Count (CBC)', '600'),
(1, 'Blood Tests', '800'),
(2, 'Urine Tests', '400'),
(3, 'Complete Blood Count (CBC)', '600'),
(4, 'Fasting Glucose Test', '200'),
(5, 'X-Rays', '500'),
(6, 'MRI (Magnetic Resonance Imaging)', '6000'),
(7, 'CT (Computed Tomography) Scans', '2000'),
(8, 'Biopsy', '1500'),
(9, 'ECG', '600');
...
(7, 'VHQA0', '7A1VK', '56', '44', '67', '33', '2024-04-13 13:20:55.640596'),
(8, 'K8LUV', 'KU8W4', '56', '44', '67', '33', '2024-04-14 08:36:00.007895');
...
--
ALTER TABLE `his_medical_records`
  MODIFY `mdr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `his_vitals`
  MODIFY `vit_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
COMMIT;
