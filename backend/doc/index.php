                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method='post'>
                                ...
                                <div class="form-group mb-0 text-center">
                                    <button class="btn btn-primary btn-block" name="doc_login" type="submit">Doctor Log In </button>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p> <a href="his_doc_reset_pwd.php" class=" ml-1">Forgot your password?</a></p>
