                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7">
                                        <div class="pl-xl-3 mt-3 mt-xl-0">
                                            <h3 class="mb-3">Name : <?php echo $row->pres_pat_name;?></h3>
                                            
                                            <h4 class="text-danger">Age : <?php echo $row->pres_pat_age;?> Years</h4>
                                            
                                            <h4 class="text-danger ">Patient Number : <?php echo $row->pres_pat_number;?></h4>
                                            
                                            <h4 class="text-danger ">Patient Category : <?php echo $row->pres_pat_type;?></h4>
                                            
                                            <h4 class="text-danger ">Patient Ailment : <?php echo $row->pres_pat_ailment;?></h4>
                                            <hr>
                                            <h3 class="align-centre mb-4">Prescription</h3>
                                            
                                            <p class="text-muted "><?php echo $row->pres_test_name;?> ||
