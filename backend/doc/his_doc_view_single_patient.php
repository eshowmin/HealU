                        ...
                        <div class="col-lg-4 col-xl-4">
                            <div class="card-box text-center">
                                ...
                                <div class="text-left mt-3">
                                    ...
                                    <p><a href="his_doc_add_single_pres.php?pat_id=<?php echo $row->pat_id;?>&&pat_number=<?php echo $row->pat_number;?>&&pat_name=<?php echo $row->pat_fname;?>_<?php echo $row->pat_lname;?>" class="badge badge-success"><i class="fas fa-highlighter"></i> Add Prescription</a></p>
                                    <hr>
                                    ...
                                    <div class="tab-pane show active" id="aboutme">
                                        <ul class="list-unstyled timeline-sm">
                                            ...
                                            <li class="timeline-sm-item">
                                                ...
                                                <!-- <p><a href="generate_presc_pdf.php?pres_id=<?php echo $row->pres_id ;?>&&pres_number=<?php echo $row->pres_number ;?>">see prescription pdf</a></p> -->
                                                <p><a href="./invoice/invoices.php?pres_id=<?php echo $row->pres_id ;?>&&pres_number=<?php echo $row->pres_number ;?>">Prescription</a></p>
                                            </li>
                                            <?php }?>
                                        </ul>
                                    ...
                                    <div class="tab-pane" id="settings">
                                        <ul class="list-unstyled timeline-sm">
                                            ...
                                            <li class="timeline-sm-item">
                                                ...
                                                <!-- <p><a href="his_doc_view_single_patient_report.php?lab_id=<?php echo $row->lab_id;?>">See New Reports </a></p> -->
                                                <hr>
