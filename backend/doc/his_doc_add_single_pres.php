<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_presc']))
		{
			...
			$query="INSERT INTO  his_prescriptions  (pres_pat_name, pres_pat_number, pres_pat_type, pres_pat_addr, pres_pat_age, pres_number, pres_pat_ailment, pres_drug_name,pres_meal_time,pres_take_for,pres_when_eat,pres_test_name) VALUES(?,?,?,?,?,?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssssssssss', $pres_pat_name, $pres_pat_number, $pres_pat_type, $pres_pat_addr, $pres_pat_age, $pres_number, $pres_pat_ailment, $pres_drug_name,$pres_meal_time,$pres_take_for,$pres_when_eat,$pres_test_name);
			$stmt->execute();
			/*
                                    ...
                                    <form method="post">
                                     ...
                                     <div class="form-row">
                                         <div class="form-group col-md-4">
                                            ...
                                            <input type="text" required="required" name="pres_drug_name" class="form-control" id="inputEmail4" placeholder="Drug Name">
                                         </div>
