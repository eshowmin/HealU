...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
            ...
            $check = "SELECT * FROM  his_patients WHERE pat_phone ='$pat_phone' ";
            $stmts= $mysqli->prepare($check) ;
            $stmts->execute() ;//ok
            $ress=$stmts->get_result();
            $rows=$ress->fetch_assoc();
			
			/*
			*Use Sweet Alerts Instead Of This Up Javascript Alerts
