	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Patient Bill Details Added";
			}
			else {
                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Patient Bill</a></li>
                                        <li class="breadcrumb-item active">Add Patient Bill </li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Add Patient Bill Details</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
