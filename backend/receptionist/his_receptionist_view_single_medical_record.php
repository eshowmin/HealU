                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-7">
                                        <div class="pl-xl-3 mt-3 mt-xl-0">
                                            <h3 class="mb-3">Patient Name : <?php echo $row->mdr_pat_name;?></h3>
                                            <!-- <hr> -->
                                            <h4 class="text-danger">Patient Age : <?php echo $row->mdr_pat_age;?> Years</h4>
                                            
                                            <h4 class="text-danger ">Patient Number : <?php echo $row->mdr_pat_number;?></h4>
                                            
                                            <h4 class="text-danger ">Patient Ailment : <?php echo $row->mdr_pat_ailment;?></h4>
                                            
                                            <h4 class="text-danger ">Date Recorded : <?php echo date("d/m/Y - h:m:s", strtotime($mysqlDateTime));?></h4>
                                            <hr>
                                            <h3 class="align-centre">Prescription</h3>
                                            
                                            <p class="text-muted mt-2"><?php echo $row->mdr_pat_ailment;?> ||
                                                    <?php echo $row->mdr_date_rec;?>
                                                </p>
