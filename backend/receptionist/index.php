...
session_start();
    ...
    if(isset($_POST['admin_login']))
    {
        ...
        $stmt=$mysqli->prepare("SELECT ad_email ,ad_pwd , ad_id FROM his_receptionist WHERE ad_email=? AND ad_pwd=? ");//sql to log in user
        ...
        if($rs)
            {//if its sucessfull
                header("location:his_receptionist_dashboard.php");
            }
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <a href="index.php">
                                    <span>
                                    <img src="assets/images/HealU.png" alt="" width="" height="80">
                                        <!-- <img src="assets/images/logo-dark.png" alt="" height="22"> -->
                                </span>
                                </a>
                                <p class="text-muted mb-4 mt-3">Enter your email address and password to access receptionists panel.</p>
                            </div>
                            ...
                            <form method='post'>
                                ...
                                <div class="form-group mb-0 text-center">
                                    <button class="btn btn-primary btn-block" name="admin_login" type="submit"> Receptionist Log In </button>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <!-- <p> <a href="his_admin_pwd_reset.php" class=" ml-1">Forgot your password?</a></p> -->
                            <p>Back to <a href="../../index.php" class="ml-1"><b>HomePage</b></a></p>
