                                ...
                                <div class="row">
                                    <div class="col-xl-5">
                                        ...
                                        <div class="tab-content pt-0">
                                            ...
                                            <div class="tab-pane active show" id="product-1-item">
                                                <img src="assets/images/patients.jpeg" alt="" class="img-fluid mx-auto d-block rounded">
                                            </div>
                                    ...
                                    <div class="col-xl-7">
                                        <div class="pl-xl-3 mt-3 mt-xl-0">
                                            <hr>
                                            <h3 class="mb-3">Patient's Name : <?php echo $row->lab_pat_name;?></h3>
                                            <!-- <hr> -->
                                            <h4 class="text-danger ">Patient Number : <?php echo $row->lab_pat_number;?></h4>
                                            <!-- <hr> -->
                                            <h4 class="text-danger ">Patient Ailment : <?php echo $row->lab_pat_ailment;?></h4>
                                            <!-- <hr> -->
                                            <h4 class="text-danger ">Date Recorded : <?php echo date("d/m/Y - h:m:s", strtotime($mysqlDateTime));?></h4>
                                            <hr>
                                            <h5>
                                                    Laboratory Tests
                                                </h5>
