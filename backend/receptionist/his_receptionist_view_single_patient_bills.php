                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Manage Patient Billings</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-lg-4 col-xl-4">
                            <div class="card-box text-center">
                                ...
                                <div class="text-left mt-3">
                                    ...
                                    <p class="text-muted mb-2 font-13"><strong>Full Name :</strong> <span class="ml-2"><?php echo $row->lab_pat_name;?> </span></p>
                                    <p class="text-muted mb-2 font-13"><strong>Patient ID :</strong><span class="ml-2"><?php echo $row->lab_pat_number;?></span></p>
                                    <p class="text-muted mb-2 font-13"><strong>Ailment :</strong> <span class="ml-2"><?php echo $row->lab_pat_ailment;?></span></p>
                                    <p class="text-muted mb-2 font-13"><strong>Test Name :</strong> <span class="ml-2"><?php echo $row->lab_pat_tests;?></span></p>
