                                        ...
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            <?php
                                                ...
                                                while($row=$res->fetch_object())
                                                {
                                                    ...
                                                    {
                                                        $action = "<td><a href='his_receptionist_update_doc_password.php?email=$row->email&pwd=$row->pwd' class='badge badge-danger'><i class='fas fa-edit'></i>Reset Password</a></td>";
                                                    }
                                                    else
                                                    {
