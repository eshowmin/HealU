...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient_lab_test']))
		{
			...
			$query="INSERT INTO  his_laboratory  (lab_pat_name, lab_pat_ailment, lab_pat_number, lab_pat_tests, lab_number,lab_test_price ) VALUES(?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $lab_pat_name, $lab_pat_ailment, $lab_pat_number, $lab_pat_tests, $lab_number,$lab_test_price);
			$stmt->execute();
			/*
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div style="display: flex;"><?php echo $row->pres_test_name;?> || <?php echo $row->pres_date;?></div>
                                  ...
                                  <select name="lab_pat_tests" class="form-control" >
                                    ...
                                    <option value="Complete Blood Count (CBC) ">Complete Blood Count (CBC) </option>
                                        ...
                                        <div class="form-group">
                                            <label for="inputAddress" class="col-form-label">Laboratory Test Price</label>
                                            <input type="text" name="lab_test_price" value="" class="form-control" id="inputZip">
