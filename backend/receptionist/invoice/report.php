                    ...
                    <div class = "invoice-head">
                        ...
                        <div class = "invoice-head-middle">
                            <div class = "invoice-head-middle-left text-start">
                                <p><span class = "text-bold">Date</span>: <?php echo $row->lab_date_rec;?></p>
                            </div>
                            <div class = "invoice-head-middle-right text-end">
                                <p><spanf class = "text-bold">Report No</span>: <?php echo $row->lab_number;?></p>
                            </div>
                        </div>
                        <div class = "hr"></div>
                        <div class = "invoice-head-bottom">
                            <div class = "invoice-head-bottom-left">
                                <ul>
                                    ...
                                    <li>Patient : <?php echo $row->lab_pat_name;?></li>
                                    <li>Patient ID : <?php echo $row->lab_pat_number;?></li>
                            ...
                            <div class = "invoice-head-bottom-right">
                                <ul class = "text-end">
                                    <li class = 'text-bold'>Hospital Info:</li>
                                    <li>HealU Inc.</li>
                    ...
                    <div class = "overflow-view">
                        <div class = "invoice-body">
                            <table>
                                <thead>
                                    <tr>
                                        <td class = "text-bold">Test Name</td>
                                    </tr>
                                    </thead>
                                    ...
                                    <thead>
                                    <tr>
                                        <td class = "text-bold">Test  Result</td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    <td><?php echo $row->lab_pat_results;?></td>
                                    </tr> 
