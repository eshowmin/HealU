                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" required="required" readonly name="lab_pat_number" value="<?php echo $row->lab_pat_number;?>" class="form-control" id="inputEmail4" placeholder="Patient ID">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required="required" name="lab_pat_tests" value="<?php echo $row->lab_pat_tests;?>" class="form-control" id="inputEmail4" placeholder="">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" required="required" name="lab_pat_results" value="" class="form-control" id="inputEmail4" placeholder="">
                                        </div>
