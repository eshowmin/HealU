                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Manage Doctor Details</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="his_admin_update_single_employee.php?doc_id=<?php echo $row->doc_id;?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Update</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <?php  $cnt = $cnt +1 ; }?>
