                                    ...
                                    <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="his_admin_assaign_single_employee.php?doc_id=<?php echo $row->doc_id;?>" class="badge badge-primary"><i class="mdi mdi-check-box-outline "></i> Assign Department</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                        <?php  $cnt = $cnt +1 ; }?>
