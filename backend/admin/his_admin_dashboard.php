                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">HealU: An Extended Hospital Management System Admin Dashboard</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-4">
                            ...
                            <!-- rounded-circle  bg-soft-primary border-primary border   text-primary -->
                                <div class="row">
                                    <div class="col-6">
                                        <div class="avatar-lg "
                                        style="background-color: #00acc1;">
                                            <i class="fab fa-accessible-icon  font-22 avatar-title "></i>
                                        </div>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="widget-rounded-circle card-box">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="avatar-lg "
                                        style="background-color: #00acc1;">
                                            <i class="mdi mdi-hotel   font-22 avatar-title "></i>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-right">
                            ...
                            <div class="widget-rounded-circle card-box">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="avatar-lg "
                                        style="background-color: #00acc1;">
                                            <i class="mdi mdi-doctor font-22 avatar-title "></i>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-right">
                                            ...
                                            <p class="text-muted mb-1 text-truncate">Hospital Doctors</p>
                                        </div>
                                    </div>
                                </div> <!-- end row-->
                            </div> <!-- end widget-rounded-circle-->
                            ...
                            <div class="widget-rounded-circle card-box">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="avatar-lg  "
                                        style="background-color: #00acc1;">
                                            <i class="fas fa-user-tag font-22 avatar-title "></i>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-right">
                            ...
                            <div class="widget-rounded-circle card-box">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="avatar-lg "
                                        style="background-color: #00acc1;">
                                            <i class="mdi mdi-flask font-22 avatar-title "></i>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-right">
                            ...
                            <div class="widget-rounded-circle card-box">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="avatar-lg "
                                        style="background-color: #00acc1;">
                                            <i class="mdi mdi-pill font-22 avatar-title "></i>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="text-right">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-box">
                                <h4 class="header-title mb-3">Hospital Patients</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-borderless table-hover table-centered m-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="width: 36px;">
                                                    <!-- <img src="../receptionist/assets/images/users/<?php echo $row->ad_dpic;?>" alt="img" title="contact-img" class="rounded-circle avatar-sm" /> -->
                                                    <img src="../receptionist/assets/images/patients.jpeg" alt=""
                                                    height="30px">
                                                </td>
                                                <td>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="his_admin_view_single_patient.php?pat_id=<?php echo $row->pat_id;?>&&pat_number=<?php echo $row->pat_number;?>" class="btn btn-xs btn-success"
