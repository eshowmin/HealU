        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li>
                            <a href="his_admin_add_receptionist.php">Add Receptionist</a>
                        </li>
                        <li>
                            <a href="his_admin_view_receptionist.php">View Receptionist</a>
                        </li>
                        <li>
                            <a href="his_admin_manage_receptionist.php">Manage Receptionists</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                    <li>
                            <a href="his_admin_manage_doctor_charge.php">Doctor Charges</a>
                        </li>
                        <li>
                            <a href="his_admin_manage_patient_properly.php">Test Charges</a>
                        </li>
...
<!-- 
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        ...
                        <li>
                            <a href="his_admin_employee_lab_vitals.php">Doctor Vitals</a>
                        </li>
                        <li>
