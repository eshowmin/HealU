...
<?php
	...
	include('assets/inc/config.php');
		...
		{
			$doc_fname=$_POST['ad_fname'];
			$doc_lname=$_POST['ad_lname'];
			$doc_number=$_POST['ad_number'];
            $doc_email=$_POST['ad_email'];
            $doc_pwd=$_POST['ad_pwd'];
            // $doc_pwd=sha1(md5($_POST['doc_pwd']));
            
            //sql to insert captured values
			$query="INSERT INTO his_receptionist (ad_fname, ad_lname, ad_number, ad_email, ad_pwd) values(?,?,?,?,?)";
			...
			*/ 
			...
			if($stmt)
			{
				$success = "Receptionist Details Added";
			}
			else {
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Add Receptionist Details</h4>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group col-md-2" style="display:none">
                                            <?php 
                                                    ...
                                                    ?>
                                            <label for="inputZip" class="col-form-label">Recptionist Number</label>
                                            <input type="text" name="ad_number" value="<?php echo $patient_number;?>" class="form-control" id="inputZip">
                                        </div>
                                        ...
                                        <button type="submit" name="add_re" class="ladda-button btn btn-success" data-style="expand-right">Add Receptionist</button>
