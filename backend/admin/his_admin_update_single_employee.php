<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_doc']))
		{
			...
			$query="UPDATE his_docs SET doc_fname=?, doc_lname=?,  doc_email=?, doc_pwd=?, doc_dpic=? WHERE doc_id = ?";
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <button type="submit" name="update_doc" class="ladda-button btn btn-success" data-style="expand-right">Add Doctor</button>
